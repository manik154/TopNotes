...
//        mRecyclerView = (RecyclerView)findViewById(R.id.toDoRecyclerView);
        ...
        if(theme.equals(LIGHTTHEME)){
            mRecyclerView.setBackgroundColor(getResources().getColor(R.color.amber));
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.share_application:
                ...
                shareBody = sAux + "https://play.google.com/store/apps/details?id=Orion.Soft \n\n";
                sharingIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Let here Be Cautious");
